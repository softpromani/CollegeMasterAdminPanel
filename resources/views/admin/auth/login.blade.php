      ...
      <div class="col-lg-7">
        ...
        <div class="card shadow-lg login-card">
          ...
          <div class="row g-0">
            ...
            <!-- Left Side -->
            <div class="col-lg-5 d-none d-lg-flex flex-column justify-content-center align-items-center p-5 login-left">

            <div class="logo-circle d-flex justify-content-center align-items-center mb-4 bg-white shadow">
...
>
    ...
    <div class="d-grid mb-4">
        ...
        <button
            type="submit"
            class="btn btn-primary btn-login shadow-sm"
        >
